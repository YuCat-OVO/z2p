...
class ChatCompletionResponseBuilder:
    ...
    def with_usage(self, prompt_tokens: int, completion_tokens: int) -> "ChatCompletionResponseBuilder":
        """设置使用统计。"""
        self._data["usage"] = {
...
class ChatCompletionChunkBuilder:
    ...
    def with_usage(self, prompt_tokens: int, completion_tokens: int) -> "ChatCompletionChunkBuilder":
        """添加使用统计（最后一个块）。"""
        self._data["usage"] = {
            "prompt_tokens": prompt_tokens,
            "completion_tokens": completion_tokens,
