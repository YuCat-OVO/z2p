...
class TestGetModelFeatures:
    ...
    def test_model_capabilities_override_thinking(self):
        ...
        result = get_model_features("glm-4.6", streaming=True, model_capabilities=capabilities)
...
class TestPrepareRequestDataAdvanced:
    ...
    async def test_file_upload_failure_handling(self, mock_access_token):
        ...
        with patch("src.z2p_svc.model_service.get_models") as mock_get_models, \
            ...
            mock_uploader.upload_base64_file = AsyncMock(side_effect=Exception("Upload failed"))
    ...
    async def test_glm46v_image_in_files_array(self, mock_access_token):
        ...
        with patch("src.z2p_svc.model_service.get_models") as mock_get_models, \
            ...
            if isinstance(last_message.get("content"), list):
                ...
                assert not any(item.get("type") == "image_url" for item in last_message["content"])
