...
class TestGenerateSignature:
    ...
    def test_different_params_different_signature(self):
        ...
        with patch("time.time", return_value=1234567890.123):
            result1 = generate_signature("requestId,test1,timestamp,123,user_id,user1", content)
            result2 = generate_signature("requestId,test2,timestamp,456,user_id,user2", content)
